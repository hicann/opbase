...
// ACLNN_ERR_INNER_KEY_CONFILICT is discarded because of word spelling issue, please use ACLNN_ERR_INNER_KEY_CONFLICT
#define ACLNN_ERR_INNER_KEY_CONFILICT 561105
#define ACLNN_ERR_INNER_KEY_CONFLICT 561105
