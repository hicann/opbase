...
static constexpr auto i2 = ge::DataType::DT_INT16;
static constexpr auto i4 = ge::DataType::DT_INT32;
static constexpr auto i8 = ge::DataType::DT_INT64;
static constexpr auto f2 = ge::DataType::DT_FLOAT16;
static constexpr auto f4 = ge::DataType::DT_FLOAT;
static constexpr auto f8 = ge::DataType::DT_DOUBLE;
static constexpr auto c2 = ge::DataType::DT_COMPLEX32;
static constexpr auto c4 = ge::DataType::DT_COMPLEX64;
static constexpr auto c8 = ge::DataType::DT_COMPLEX128;
static constexpr auto b1 = ge::DataType::DT_BOOL;
static constexpr auto bf = ge::DataType::DT_BF16;
static constexpr auto ud = ge::DataType::DT_UNDEFINED;
...
{
    if (static_cast<int>(type_a) < 0 || static_cast<int>(type_b) < 0 ||
        static_cast<int>(type_a) >= static_cast<int>(ge::DataType::DT_MAX) ||
        static_cast<int>(type_b) >= static_cast<int>(ge::DataType::DT_MAX)) {
