...
public:
    ...
    {
        uint64_t offset = 0;
        uint64_t loopNum = GetBlockIdx() == tilingData->blockNum - 1 ? tilingData->ubLoopOfTailBlock :
                                                                       tilingData->ubLoopOfFormerBlock;
        uint64_t tailNum = GetBlockIdx() == tilingData->blockNum - 1 ? tilingData->ubTailOfTailBlock :
