...
/*!
 * \file reduce_tiling_key_decl_batch_invariant.h
 * \brief reduce tiling key declare batch invariant
 */

#ifndef _REDUCE_TILING_KEY_DECL_BATCH_INVARIANT_H_
#define _REDUCE_TILING_KEY_DECL_BATCH_INVARIANT_H_
#include "ascendc/host_api/tiling/template_argument.h"
#include "reduce_tiling_key_decl.h"

#define REDUCE_TPL_KEY_DECL_BATCH_INVARIANT()                                                   \
    ASCENDC_TPL_BOOL_DECL(IsContiguous, C0, C1), ASCENDC_TPL_BOOL_DECL(BatchInvariant, C0, C1), \
...
#define REDUCE_TPL_KEY_SEL_EMPTY_BATCH_INVARIANT()                                                             \
    ASCENDC_TPL_KERNEL_TYPE_SEL(ASCENDC_TPL_AIV_ONLY), ASCENDC_TPL_BOOL_SEL(IsContiguous, C1),                 \
        ASCENDC_TPL_BOOL_SEL(BatchInvariant, C0, C1), ASCENDC_TPL_UINT_SEL(PatternID, ASCENDC_TPL_UI_LIST, 0), \
        ASCENDC_TPL_UINT_SEL(LoopARCount, ASCENDC_TPL_UI_LIST, 0),                                             \
        ASCENDC_TPL_UINT_SEL(LoopInnerARCount, ASCENDC_TPL_UI_LIST, 0)

#define REDUCE_TPL_KEY_SEL_A_BATCH_INVARIANT()                                                                    \
    ASCENDC_TPL_KERNEL_TYPE_SEL(ASCENDC_TPL_AIV_ONLY), ASCENDC_TPL_BOOL_SEL(IsContiguous, C1),                    \
        ASCENDC_TPL_BOOL_SEL(BatchInvariant, C0, C1), ASCENDC_TPL_UINT_SEL(PatternID, ASCENDC_TPL_UI_LIST, C100), \
        ASCENDC_TPL_UINT_SEL(LoopARCount, ASCENDC_TPL_UI_LIST, A1R0),                                             \
        ASCENDC_TPL_UINT_SEL(LoopInnerARCount, ASCENDC_TPL_UI_LIST, C0)

#define REDUCE_TPL_KEY_SEL_AR_NORMAL_BATCH_INVARIANT()                                             \
    ASCENDC_TPL_KERNEL_TYPE_SEL(ASCENDC_TPL_AIV_ONLY), ASCENDC_TPL_BOOL_SEL(IsContiguous, C0, C1), \
        ASCENDC_TPL_BOOL_SEL(BatchInvariant, C0, C1),                                              \
...
#define REDUCE_TPL_KEY_SEL_AR_GROUP_BATCH_INVARIANT()                                                 \
    ASCENDC_TPL_KERNEL_TYPE_SEL(ASCENDC_TPL_MIX_AIV_1_0), ASCENDC_TPL_BOOL_SEL(IsContiguous, C0, C1), \
        ASCENDC_TPL_BOOL_SEL(BatchInvariant, C0, C1),                                                 \
        ASCENDC_TPL_UINT_SEL(PatternID, ASCENDC_TPL_UI_LIST, AR_PATTERN),                             \
        ASCENDC_TPL_UINT_SEL(LoopARCount, ASCENDC_TPL_UI_LIST, A1R2),                                 \
        ASCENDC_TPL_UINT_SEL(LoopInnerARCount, ASCENDC_TPL_UI_LIST, C0)

#define REDUCE_TPL_KEY_SEL_ARA_NORMAL_BATCH_INVARIANT()                                            \
    ASCENDC_TPL_KERNEL_TYPE_SEL(ASCENDC_TPL_AIV_ONLY), ASCENDC_TPL_BOOL_SEL(IsContiguous, C0, C1), \
        ASCENDC_TPL_BOOL_SEL(BatchInvariant, C0, C1),                                              \
...
#define REDUCE_TPL_KEY_SEL_ARA_GROUP_BATCH_INVARIANT()                                                \
    ASCENDC_TPL_KERNEL_TYPE_SEL(ASCENDC_TPL_MIX_AIV_1_0), ASCENDC_TPL_BOOL_SEL(IsContiguous, C0, C1), \
        ASCENDC_TPL_BOOL_SEL(BatchInvariant, C0, C1),                                                 \
        ASCENDC_TPL_UINT_SEL(PatternID, ASCENDC_TPL_UI_LIST, ARA_PATTERN),                            \
...
#define REDUCE_TPL_KEY_SEL_ARAR_NORMAL_BATCH_INVARIANT()                                           \
    ASCENDC_TPL_KERNEL_TYPE_SEL(ASCENDC_TPL_AIV_ONLY), ASCENDC_TPL_BOOL_SEL(IsContiguous, C0, C1), \
        ASCENDC_TPL_BOOL_SEL(BatchInvariant, C0, C1),                                              \
...
#define REDUCE_TPL_KEY_SEL_ARAR_GROUP_BATCH_INVARIANT()                                               \
    ASCENDC_TPL_KERNEL_TYPE_SEL(ASCENDC_TPL_MIX_AIV_1_0), ASCENDC_TPL_BOOL_SEL(IsContiguous, C0, C1), \
        ASCENDC_TPL_BOOL_SEL(BatchInvariant, C0, C1),                                                 \
        ASCENDC_TPL_UINT_SEL(PatternID, ASCENDC_TPL_UI_LIST, ARAR_PATTERN),                           \
...
#define REDUCE_TPL_KEY_SEL_ARARARAR_NORMAL_BATCH_INVARIANT()                                       \
    ASCENDC_TPL_KERNEL_TYPE_SEL(ASCENDC_TPL_AIV_ONLY), ASCENDC_TPL_BOOL_SEL(IsContiguous, C0, C1), \
        ASCENDC_TPL_BOOL_SEL(BatchInvariant, C0, C1),                                              \
...
#define REDUCE_TPL_KEY_SEL_ARARARAR_GROUP_BATCH_INVARIANT()                                                           \
    ASCENDC_TPL_KERNEL_TYPE_SEL(ASCENDC_TPL_MIX_AIV_1_0), ASCENDC_TPL_BOOL_SEL(IsContiguous, C0, C1),                 \
        ASCENDC_TPL_BOOL_SEL(BatchInvariant, C0, C1),                                                                 \
        ASCENDC_TPL_UINT_SEL(PatternID, ASCENDC_TPL_UI_LIST, ARARARAR_PATTERN),                                       \
...
#define REDUCE_TPL_KEY_SEL_ARARARARA_NORMAL_BATCH_INVARIANT()                                      \
    ASCENDC_TPL_KERNEL_TYPE_SEL(ASCENDC_TPL_AIV_ONLY), ASCENDC_TPL_BOOL_SEL(IsContiguous, C0, C1), \
        ASCENDC_TPL_BOOL_SEL(BatchInvariant, C0, C1),                                              \
...
#define REDUCE_TPL_KEY_SEL_ARARARARA_GROUP_BATCH_INVARIANT()                                                          \
    ASCENDC_TPL_KERNEL_TYPE_SEL(ASCENDC_TPL_MIX_AIV_1_0), ASCENDC_TPL_BOOL_SEL(IsContiguous, C0, C1),                 \
        ASCENDC_TPL_BOOL_SEL(BatchInvariant, C0, C1),                                                                 \
        ASCENDC_TPL_UINT_SEL(PatternID, ASCENDC_TPL_UI_LIST, ARARARARA_PATTERN),                                      \
        ASCENDC_TPL_UINT_SEL(                                                                                         \
