...
/*!
 * \file reduce_tiling_key_decl_full.h
 * \brief reduce tiling key declare batch invariant
 */

#ifndef _REDUCE_TILING_KEY_DECL_FULL_H_
#define _REDUCE_TILING_KEY_DECL_FULL_H_
#include "ascendc/host_api/tiling/template_argument.h"
#include "reduce_tiling_key_decl.h"

#define REDUCE_TPL_KEY_DECL_FULL()                                                              \
...
#define REDUCE_TPL_KEY_SEL_EMPTY_FULL()                                                                        \
...
#define REDUCE_TPL_KEY_SEL_A_FULL()                                                                               \
    ASCENDC_TPL_KERNEL_TYPE_SEL(ASCENDC_TPL_AIV_ONLY), ASCENDC_TPL_BOOL_SEL(IsContiguous, C1),                    \
...
#define REDUCE_TPL_KEY_SEL_AR_NORMAL_FULL()                                                        \
...
#define REDUCE_TPL_KEY_SEL_AR_GROUP_FULL()                                                            \
...
#define REDUCE_TPL_KEY_SEL_ARA_NORMAL_FULL()                                                       \
    ASCENDC_TPL_KERNEL_TYPE_SEL(ASCENDC_TPL_AIV_ONLY), ASCENDC_TPL_BOOL_SEL(IsContiguous, C0, C1), \
        ASCENDC_TPL_BOOL_SEL(BatchInvariant, C0, C1),                                              \
...
#define REDUCE_TPL_KEY_SEL_ARA_GROUP_FULL()                                                           \
    ASCENDC_TPL_KERNEL_TYPE_SEL(ASCENDC_TPL_MIX_AIV_1_0), ASCENDC_TPL_BOOL_SEL(IsContiguous, C0, C1), \
        ASCENDC_TPL_BOOL_SEL(BatchInvariant, C0, C1),                                                 \
        ASCENDC_TPL_UINT_SEL(PatternID, ASCENDC_TPL_UI_LIST, ARA_PATTERN),                            \
...
#define REDUCE_TPL_KEY_SEL_ARAR_NORMAL_FULL()                                                      \
    ASCENDC_TPL_KERNEL_TYPE_SEL(ASCENDC_TPL_AIV_ONLY), ASCENDC_TPL_BOOL_SEL(IsContiguous, C0, C1), \
        ASCENDC_TPL_BOOL_SEL(BatchInvariant, C0, C1),                                              \
...
#define REDUCE_TPL_KEY_SEL_ARAR_GROUP_FULL()                                                          \
    ASCENDC_TPL_KERNEL_TYPE_SEL(ASCENDC_TPL_MIX_AIV_1_0), ASCENDC_TPL_BOOL_SEL(IsContiguous, C0, C1), \
        ASCENDC_TPL_BOOL_SEL(BatchInvariant, C0, C1),                                                 \
        ASCENDC_TPL_UINT_SEL(PatternID, ASCENDC_TPL_UI_LIST, ARAR_PATTERN),                           \
...
#define REDUCE_TPL_KEY_SEL_ARARARAR_NORMAL_FULL()                                                  \
    ASCENDC_TPL_KERNEL_TYPE_SEL(ASCENDC_TPL_AIV_ONLY), ASCENDC_TPL_BOOL_SEL(IsContiguous, C0, C1), \
        ASCENDC_TPL_BOOL_SEL(BatchInvariant, C0, C1),                                              \
...
#define REDUCE_TPL_KEY_SEL_ARARARAR_GROUP_FULL()                                                                     \
    ASCENDC_TPL_KERNEL_TYPE_SEL(ASCENDC_TPL_MIX_AIV_1_0), ASCENDC_TPL_BOOL_SEL(IsContiguous, C0, C1),                \
        ASCENDC_TPL_BOOL_SEL(BatchInvariant, C0, C1),                                                                \
        ASCENDC_TPL_UINT_SEL(PatternID, ASCENDC_TPL_UI_LIST, ARARARAR_PATTERN),                                      \
...
#define REDUCE_TPL_KEY_SEL_ARARARARA_NORMAL_FULL()                                                 \
    ASCENDC_TPL_KERNEL_TYPE_SEL(ASCENDC_TPL_AIV_ONLY), ASCENDC_TPL_BOOL_SEL(IsContiguous, C0, C1), \
        ASCENDC_TPL_BOOL_SEL(BatchInvariant, C0, C1),                                              \
...
#define REDUCE_TPL_KEY_SEL_ARARARARA_GROUP_FULL()                                                                    \
    ASCENDC_TPL_KERNEL_TYPE_SEL(ASCENDC_TPL_MIX_AIV_1_0), ASCENDC_TPL_BOOL_SEL(IsContiguous, C0, C1),                \
        ASCENDC_TPL_BOOL_SEL(BatchInvariant, C0, C1),                                                                \
        ASCENDC_TPL_UINT_SEL(PatternID, ASCENDC_TPL_UI_LIST, ARARARARA_PATTERN),                                     \
        ASCENDC_TPL_UINT_SEL(LoopARCount, ASCENDC_TPL_UI_LIST, A1R2, A1R3, A1R4, A1R5, A2R3, A2R4, A2R5, A2R6, A3R4, \
