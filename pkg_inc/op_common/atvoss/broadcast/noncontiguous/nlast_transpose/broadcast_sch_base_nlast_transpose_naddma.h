...
/* !
 * \file broadcast_sch_base_nlast_transpose_naddma.h
 * \brief
 */
#ifndef BROADCAST_SCH_BASE_NLAST_TRANSPOSE_NADDMA_H_
#define BROADCAST_SCH_BASE_NLAST_TRANSPOSE_NADDMA_H_
...
protected:
     ...
     */
    template <typename Op, int pos>
    __aicore__ inline void CopyOut(uint64_t offset, uint64_t tileLength, int32_t pingPong, int64_t ubSplitSize)
    {
