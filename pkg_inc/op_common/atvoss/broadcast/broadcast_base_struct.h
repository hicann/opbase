...
#define BRC_VEC_SCH_CUSTOM_MODE_KEY_DECL(schMode) \
    ASCENDC_TPL_UINT_DECL(                        \
        schMode, 16, ASCENDC_TPL_UI_LIST, 101, 102, 103, 104, 109, 201, 202, 301, 302, 303, 304, 305, 999)
...
#define BRC_TEMP_SCH_MODE_KEY_DECL(schMode) \
    ASCENDC_TPL_UINT_DECL(                  \
        schMode, 16, ASCENDC_TPL_UI_LIST, 1, 2, 101, 102, 103, 104, 109, 201, 202, 301, 302, 303, 304, 305, 999)
