...
TEST_F(TestBinaryReuse, LogFloat16AndFloat)
{
    ...
    CreateSingleInAndout("Log", aclDataType::ACL_FLOAT16, aclFormat::ACL_FORMAT_NCHW, filePrefix, -1.0, 1.0, 0.0);
    filePrefix = "kernel/ascend910/log/Log_fb42ea349cd1f1779279250bf66d5d90_high_performance";
    CreateSingleInAndout("Log", aclDataType::ACL_FLOAT, aclFormat::ACL_FORMAT_ND, filePrefix, 2.0, 1.0, 0.0);
    filePrefix = "";
    CreateSingleInAndout("Log", aclDataType::ACL_FLOAT, aclFormat::ACL_FORMAT_ND, filePrefix, 3.0, 1.0, 0.0);
}
...
TEST_F(TestBinaryReuse, LpNormUpdate)
{
    ...
    CreateSingleInAndout("LpNormUpdate", aclDataType::ACL_FLOAT, aclFormat::ACL_FORMAT_NCHW, filePrefix, 0, 1e-12);

    filePrefix = "";
    CreateSingleInAndout("LpNormUpdate", aclDataType::ACL_FLOAT, aclFormat::ACL_FORMAT_NCHW, filePrefix, 1, 1.0);

    filePrefix = "";
    CreateSingleInAndout("LpNormUpdate", aclDataType::ACL_FLOAT, aclFormat::ACL_FORMAT_NCHW, filePrefix, 4, 0.0);

    filePrefix = "kernel/ascend910/lp_norm_update/LpNormUpdate_b718a1eaea6b8a3f44c2f37bd05db2d5_high_performance";
    CreateSingleInAndout("LpNormUpdate", aclDataType::ACL_FLOAT, aclFormat::ACL_FORMAT_NCHW, filePrefix, 3, 0.0);

    filePrefix = "";
    CreateSingleInAndout("LpNormUpdate", aclDataType::ACL_FLOAT, aclFormat::ACL_FORMAT_NCHW, filePrefix, 3, 0.0000001);
}
...
TEST_F(TestBinaryReuse, Renorm)
{
    ...
    CreateSingleInAndout("Renorm", aclDataType::ACL_FLOAT, aclFormat::ACL_FORMAT_NCHW, filePrefix, 1.0);
