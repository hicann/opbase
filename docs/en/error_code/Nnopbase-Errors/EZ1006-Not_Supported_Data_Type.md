...
The following is error format. The meanings of the placeholders %s in sequence are: operator name, data type, expected value.
...
Please modify the data type as prompted in the error message.
