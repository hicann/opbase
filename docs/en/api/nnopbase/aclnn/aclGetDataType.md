...
Obtains the data type of the aclTensor created by calling the [aclCreateTensor](aclCreateTensor.md) API.
...
| --- | --- | --- |
| tensor | Input| Input aclTensor.|
| dataType | Output| Returned data type of the aclTensor.|
...
- If error code 161001 is returned, `tensor` or `dataType` is a null pointer.
