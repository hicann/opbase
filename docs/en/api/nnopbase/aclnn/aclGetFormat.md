...
Obtains the data format of the aclTensor created by calling the [aclCreateTensor](aclCreateTensor.md) API.
...
| format | Output| Returned data format of the aclTensor.|
...
- If error code 161001 is returned, `tensor` or `format` is a null pointer.
