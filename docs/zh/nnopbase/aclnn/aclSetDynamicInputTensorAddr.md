...
<td class="cellrowborder" valign="top" width="46.47%" headers="mcps1.1.4.1.3 "><p id="p857014121295"><a name="p857014121295"></a><a name="p857014121295"></a>需要刷新到指定aclTensor中的Device存储地址，该地址必须32字节对齐，否则可能会出现未定义错误。</p>
</td>
</tr>
</tbody>
</table>
