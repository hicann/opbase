...
下载[eigen](https://gitcode.com/cann-src-third-party/eigen/releases/download/5.0.0-h0.trunk/eigen-5.0.0.tar.gz)，并解压到```${cann_3rd_lib_path}/```目录下，再将解压后的`eigen-5.0.0`目录重命名为`eigen`。
