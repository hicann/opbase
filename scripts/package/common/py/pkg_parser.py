...
from .utils.pkg_utils import (
    ...
    InstallScriptFormatError, InstallScriptNotInPackageError, PackageError,
    MultiPkgModError, MultiPkgSoftlinkError, PkgInnerSoftlinkNotAllowed,
...
def parse_block_config(loaded_block: LoadedBlockElement,
    ...
    pkg_mods = parse_paths_element(
        loaded_block.root_ele, 'pkg_mod', MultiPkgModError(),
        # tar.gz才处理pkg_mod元素
    ...
    pkg_softlinks = parse_paths_element(
        loaded_block.root_ele, 'pkg_softlink', MultiPkgSoftlinkError(),
    ...
    return BlockConfig(
        ...
        pkg_mods, pkg_softlinks, generate_infos,
    )
